...
import Band from '../routes/BandPage';
...
export const MENU_LIST = [
    ...
    new PageNavigationItem('/band-members', 'Members', <Band/>),
    new PageNavigationItem('/music', 'Music', <Music/>),
    new PageNavigationItem('/tour', 'Agenda', <Tour/> ),
    new PageNavigationItem('/contact', 'Contact', <Contact/>),
    new PageNavigationItem('/subscribe', 'Shop', <Subscribe/>)
]